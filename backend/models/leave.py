...
class LeaveBalance(Base):
    ...
    year       = Column(Integer, default=lambda: datetime.now().year, index=True)
...
class Leave(Base):
    ...
    status      = Column(String, default="pending", index=True)  # pending/approved/rejected/cancelled/cancel_requested
