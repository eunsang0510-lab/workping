...
export const SCREEN_LABELS: Record<string, string> = {
  ...
  "/meeting/write": "회의록 수기 작성",
  "/meeting/progress": "팀 업무 진행 현황",
  "/evaluation": "평가관리자",
  "/evaluation/mine": "내 평가",
  "/evaluation/team": "평가 검토 · 등급 부여",
  "/evaluation/review": "평가 전체 현황 검토",
  "/evaluation/settings": "AI 평가 설정",
  "/evaluation/one-on-one/record": "1on1 면담 녹음",
  "/evaluation/one-on-one/monitor": "1on1 모니터링",
  "/calendar": "근무 달력",
  "/report": "리포트",
  "/notice": "공지사항",
  "/manager": "팀장 페이지",
